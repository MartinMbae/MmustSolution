...
import studios.luxurious.mmustsolution.Leisure.flappybird.domain.Pipe;
...
public class GameView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void init() {
        ...
        // For the bird
        bitmap = getBitmapFromVectorDrawable(getContext(), R.drawable.flappy_bird_icon);
            ...
            if ((pipe.getPositionX() >= measuredWidth / 2.0f - pipeWidth / 2.0f - 100.0f / 2.0f) &&
                ...
                if ((positionY <= measuredHeight - pipe.getHeight() - gap + 50.0f / 2.0f) ||
                    ...
                    if (pipe.getPositionX() - pipeVelocity <
                        ...
                        // Update the score in MainActivity_BalloonPop
